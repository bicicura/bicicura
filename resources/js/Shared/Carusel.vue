<template>
  <section class="pb-24 mx-auto mt-24 space-y-6">
        <div class="relative w-full max-w-4xl mx-auto border-2 border-black hero-card bg-water-green rounded-xl">
            ...
            <img class="object-cover object-center w-full h-full rounded-xl" src="/imgs/street.webp" alt="" >
        </div>
